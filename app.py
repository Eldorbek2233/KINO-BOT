...
MONGODB_URI = os.getenv('MONGODB_URI', 'mongodb+srv://eldorbekxakimxujayev4:7cszqUNVFq6TPGz1@kinobot-cluster.quzswag.mongodb.net/kinobot?retryWrites=true&w=majority&appName=kinobot-cluster')
